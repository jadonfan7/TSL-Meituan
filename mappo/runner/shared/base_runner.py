...
class Runner(object):
    def __init__(self, config):
        ...
        self.max_num_agents = 3100
        self.max_share_observation_space = self.max_num_agents * 52
        ...
        logger.remove()
        logger.add("mappo_logs/env_step_log.log", rotation="500 MB", level="INFO")
        logger.add("mapppo_logs/env_episode_log.log", rotation="500 MB", level="SUCCESS")
    ...
    def add_new_agent(self, num):
        ...
        # for agent_id in range(num):
            ...
            # self.buffer = np.concatenate((self.buffer, bu), axis=1) 
