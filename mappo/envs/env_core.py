...
class EnvCore(object):
    ...
    def __init__(self, algo_index=0):        

        self.current_step = 0
        self.algo_index = algo_index
        self.map = Map(algo_index=self.algo_index)
        ...
        self.share_obs_dim = self.obs_dim * self.num_agent
    ...
    def step(self, action_n):
        ...
        reward_n = np.array(reward_n).reshape(-1, 1)
