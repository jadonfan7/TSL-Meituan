...
class Map:
    ...
    def _get_nearby_couriers(self, order, dist_range=1000):
        # nearby_couriers_info = dict()
        nearby_couriers = []
        ...
        #         if not risk:
        #             nearby_couriers_info[courier] = cost
        #             nearby_couriers.append(courier)
        # return nearby_couriers, nearby_couriers_info
