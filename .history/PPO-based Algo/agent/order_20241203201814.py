class Order:
    ...
    def __repr__(self):
        message = 'cls: ' + type(self).__name__  + ', order_id: ' + str(self.orderid) + ', status: '  + ', status: ' + self.status + ', pick_up_point: ' + str(self.pick_up_point) + ', drop_off_point: ' + str(self.drop_off_point) + ', pair_time: ' + str(self.pair_time) + ''
