...
class Courier:
    ...
    def __repr__(self):
        message = 'cls: ' + type(self).__name__ + ', courier_id: ' + str(self.courierid) + ', type: ' + str(self.courier_type) + ', position: ' + str(self.position) + ', travel_distance: ' + str(self.travel_distance) + ', income: ' + str(self.income)
