...
class EnvRunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            self.writter.add_scalar('Average Price/Total', reject, episode + 1)
            self.writter.add_scalar('Average Price/Courier0', reject0, episode + 1)
            self.writter.add_scalar('Average Price/Courier1', reject1, episode + 1)
