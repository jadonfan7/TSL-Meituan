...
class EnvRunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            print(f"Average Travel Distance per Courier0: {distance0} meters, Courier1: {distance1} meters, Total: {courier0_distance_per_episode + courier1_distance_per_episode} meters")
