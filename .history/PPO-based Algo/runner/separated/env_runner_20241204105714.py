...
class EnvRunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            self.writter.add_scalar('Average Income/Total', finish, episode + 1)
            self.writter.add_scalar('Average Income/Courier0', finish0, episode + 1)
            self.writter.add_scalar('Average Income/Courier1', finish1, episode + 1)
