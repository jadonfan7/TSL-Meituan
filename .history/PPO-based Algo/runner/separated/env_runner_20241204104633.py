...
class EnvRunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            print(f"Courier0 average speed is {avg0_speed}, Courier1 leisure time is {avg1_speed} and Total leisure time per courier is {avg_speed}")
            self.writter.add_scalar('Average Speed/Total', avg_leisure, episode + 1)
            self.writter.add_scalar('Average Speed/Courier0', avg0_leisure, episode + 1)
            self.writter.add_scalar('Average Speede/Courier1', avg1_leisure, episode + 1)
