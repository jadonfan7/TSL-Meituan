...
class EnvRunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            print(f"The average price of Courier0's order is {price_per_order0} with {order0_num} orders, Courier1's is {order1_price} with {order1_num} orders, for all is {order_price}")
