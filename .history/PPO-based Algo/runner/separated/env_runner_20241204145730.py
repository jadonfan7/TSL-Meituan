...
class EnvRunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            + f"\nAverage Travel Distance for Episode {episode+1}: Courier0 - {distance0} meters, Courier1 - {distance1} meters, Total - {distance} meters\n" 
            ...
            + f"The average price for Episode {episode+1}: Courier0 - {price_per_order0} yuan with {order0_num} orders, Courier1 - {price_per_order1} yuan with {order1_num} orders, Total - {order_price}\n"
