...
class EnvRunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            print(f"Average Travel Distance per Courier0: {courier0_distance_per_episode} meters, Courier1: {courier1_distance_per_episode} meters, Total: {courier0_distance_per_episode + courier1_distance_per_episode}")
            print(f"Average Travel Distance per Courier1: {courier1_distance_per_episode} meters")
