...
class EnvRunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            self.writter.add_scalar('Total Distance/Courier', courier1_distance_per_episode, episode + 1)
