...
class EnvRunner(Runner):
    ...
    def run(self):
        ...
        courier0_income = [f[0] for f in courier_finish_num_total]
        courier1_income = [f[1] for f in courier_finish_num_total]
        courier_incomeh = [f[2] for f in courier_finish_num_total]
        plt.figure(figsize=(10, 6))
