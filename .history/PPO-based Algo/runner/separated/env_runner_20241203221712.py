...
class EnvRunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            distance.append([courier0_distance_per_episode, courier1_distance_per_episode])
            ...
            self.writter.add_scalar('Total Distance/courier_0', courier0_distance_per_episode, episode + 1)
            self.writter.add_scalar('Total Distance/courier_1', courier1_distance_per_episode, episode + 1)

            overspeed0 = count_overspeed0 / num_active_courier0
            overspeed1 = count_overspeed1 / num_active_courier1
            print(f"Rate of Overspeed for Episode {episode+1}: Courier0 - {overspeed0}, Courier1 - {overspeed1}")
            rate_of_overspeed.append([overspeed0, overspeed1])
            self.writter.add_scalar('Overspeed Rate/courier', overspeed, episode + 1)
        ...
        courier0_distances = [d[0] for d in distance]  # 提取每个 episode 中骑手 0 的距离
        courier1_distances = [d[1] for d in distance]  # 提取每个 episode 中骑手 1 的距离
