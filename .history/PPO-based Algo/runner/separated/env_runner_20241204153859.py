...
class EnvRunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            print(f"There are {courier0_num / self.envs.num_envs} Courier0, {courier1_num / self.envs.num_envs} Courier1 with {courier1_on}, {order0_num / self.envs.num_envs} Order0, {order1_num / self.envs.num_envs} Order1, {order_wait / self.envs.num_envs} Orders waiting to be paired")                
