...
class EnvRunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            distance0 = courier0_distance_per_episode / courier0_num
            distance1 = courier1_distance_per_episode / courier1_num
            ...
            print(f"Average Travel Distance per Courier0: {distance0} meters, Courier1: {courier1_distance_per_episode} meters, Total: {courier0_distance_per_episode + courier1_distance_per_episode} meters")
            ...
            + f"\nAverage Travel Distance for Episode {episode+1}: Courier0 - {distance0}, Courier1 - {courier1_distance_per_episode}, Total - {courier0_distance_per_episode + courier1_distance_per_episode}\n" 
