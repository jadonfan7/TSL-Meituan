...
class EnvRunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            distance = (courier0_distance_per_episode + courier1_distance_per_episode)/ (distance0 + distance1)
            ...
            print(f"Courier0 rejects average {reject0} orders, Courier1 rejects average {reject1} orders, Total reject number per courier is {reject}")
            ...
            print(f"The average price of Courier0's order is {price_per_order0} yuan with {order0_num} orders, Courier1's is {price_per_order1} yuan with {order1_num} orders, for all is {order_price}")
            ...
            print(f"Courier0's average income is {income0} yuan, Courier1's average income is {income1} yuan and Total income per courier is {income}")
            ...
            + f"\nAverage Travel Distance for Episode {episode+1}: Courier0 - {distance0}, Courier1 - {distance1}, Total - {distance}\n" 
