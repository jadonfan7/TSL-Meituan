...
class EnvRunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            self.writter.add_scalar('Average Leisure Time/Total', avg0_leisure, episode + 1)
            self.writter.add_scalar('Average Leisure Time/Courier0', finish0, episode + 1)
            self.writter.add_scalar('Average Leisure Time/Courier1', finish1, episode + 1)
