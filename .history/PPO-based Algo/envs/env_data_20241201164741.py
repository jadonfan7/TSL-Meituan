...
class Map:
    ...
    def _accept_or_reject(order, courier):
        ...
        X = (reward, fairness, num_waybill, potential_overspeed_risk, rejection_history_count, is_in_the_same_da_and_poi, is_prebooked, pick_up_distance, drop_off_distance, estimate_arrived_time, esit)
