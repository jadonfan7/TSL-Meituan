...
class Map:
    def __init__(self, env_index=0, algo_index=0):
        ...
        self.interval = 10 # allocation for every10 seconds
    ...
    def step(self, first_time=0):
        ...
        for courier in self.couriers:
            if courier.leisure_time != 0:
                courier.total_leisure_time += self.interval
            if courier.waybill == [] and courier.wait_to_pick == [] and self.clock - courier.leisure_time > 300: # 5 minutes
    ...
    def _get_order_price(self, order, courier):
