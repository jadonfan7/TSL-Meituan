...
class Map:
    ...
    def _wage_response_model(self, order, courier):
        ...
        delivery_time = courier_total_time - courier.total_leisure_time
        
        income_per_sec = courier.income / courier_total_time
        v = 4 # 4 m/s
        
        wage = 
        
        r = geodesic(order.pick_up_point, courier.position)
        d = geodesic()
